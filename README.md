this is a small example of a movies website the main project in pro.js you can run it by writing node pro.js on the terminal and there are html files for the views.
